                                        ...
                                        <td valign="top" class="comment-body">
                                            ...
                                            <div class="comment-action hidden-by-mouse">
                                                ...
                                                <?php if('waiting' == $comments->status): ?>
                                                    <span class="weak btn btn-primary btn-sm"><?php _e('待审核'); ?></span>
                                                <?php else: ?>
                                                    <a href="<?php $security->index('/action/comments-edit?do=waiting&coid=' . $comments->coid); ?>" class="operate-waiting btn btn-primary btn-sm"><?php _e('待审核'); ?></a>
                                                <?php endif; ?>
